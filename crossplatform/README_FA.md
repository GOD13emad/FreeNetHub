...
- Linux native: 4.2.0-linux.5 روی Ubuntu 24.04.5 پذیرفته شده است. WARP، GTK4/Libadwaita UI، UUID-owned Console Gateway، strict legacy migration، isolated Firefox، integrity/install/uninstall lifecycle و AUTO Tor fallback runtime evidence دارند؛ AUTO در پذیرش نهایی پس از Direct probe به obfs4 رفت و bootstrap=100/HTTPS=PASS شد.
